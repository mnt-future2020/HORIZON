        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
          <div className="lg:col-span-2 space-y-4">
            {[
              ...
              <div key={label} className="rounded-[24px] bg-card border border-border/40 shadow-sm p-6 flex items-start gap-4">
          ...
          <div className="lg:col-span-3">
            {submitted ? (
              <div className="rounded-[24px] bg-card border border-border/40 shadow-sm p-10 flex flex-col items-center justify-center text-center gap-4">
              ...
              <div className="rounded-[24px] bg-card border border-border/40 shadow-sm p-6 sm:p-8">
