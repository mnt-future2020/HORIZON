    ...
    <div className="min-h-screen bg-[#0a0c0a] text-white">
        ...
        <div className="px-6 md:px-12 py-5">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3 md:gap-4">
              <button
                onClick={() => navigate(-1)}
                className="inline-flex items-center gap-2 px-4 py-2 text-sm text-white/60 hover:text-white transition-colors"
              >
      ...
      <div className="border-t border-white/10 py-8 px-6 md:px-12">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          <Link to="/" className="text-xl font-black tracking-tighter text-brand-600 font-brier">LOBBI</Link>
          <p className="text-xs text-white/30">© {new Date().getFullYear()} Magizh NexGen Technologies. All rights reserved.</p>
          <div className="flex items-center gap-4">
            <Link to="/venues" className="text-xs text-white/40 hover:text-brand-400 transition-colors uppercase font-bold">Venues</Link>
            <Link to="/about" className="text-xs text-white/40 hover:text-brand-400 transition-colors uppercase font-bold">About</Link>
            <Link to="/" className="text-xs text-white/40 hover:text-brand-400 transition-colors uppercase font-bold">Home</Link>
          </div>
        </div>
      </div>
    </div>
