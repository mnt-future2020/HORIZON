              ...
              {venues.map((venue, idx) => (
                <motion.div key={venue.id} layout initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }}
                  ...
                  <div className="p-6 flex flex-col flex-grow">
                    <h3 className="font-display text-2xl font-black tracking-tighter uppercase text-zinc-900 mb-2 truncate group-hover:text-zinc-500 transition-colors duration-300"
