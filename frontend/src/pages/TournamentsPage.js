                  ...
                  <div className="flex items-start justify-between gap-3">
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 mb-1.5 flex-wrap">
                        <Badge className={`text-[10px] font-bold ${STATUS_COLORS[t.status] || ""}`}>
          ...
          <div className="space-y-3 pt-2">
            <div>
              ...
              <Input value={form.name} onChange={e => setForm(p => ({ ...p, name: e.target.value }))}
                placeholder="e.g. Weekend Knockout Cup" className="mt-1 bg-background border-border"
                data-testid="tournament-name-input" />
            </div>
            <div>
              <Label className="text-xs text-muted-foreground">Description</Label>
              <Input value={form.description} onChange={e => setForm(p => ({ ...p, description: e.target.value }))}
                placeholder="Brief description" className="mt-1 bg-background border-border" />
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div>
                ...
                <Input type="number" value={form.entry_fee}
                  ...
                  placeholder="0 = Free" className="mt-1 bg-background border-border" />
              </div>
            </div>
            {venues.length > 0 && (
              <div>
            ...
            <div>
              ...
              <Input value={form.prize_pool}
                onChange={e => setForm(p => ({ ...p, prize_pool: e.target.value }))}
                placeholder="e.g. ₹10,000 + Trophy" className="mt-1 bg-background border-border" />
            </div>
            <div className="grid grid-cols-2 gap-3">
              <div>
