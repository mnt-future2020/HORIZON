  ...
  return (
    <>
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h3 className="font-display font-bold text-lg text-foreground">Business Overview</h3>
          <p className="text-xs text-muted-foreground mt-0.5">Your venue performance metrics</p>
        </div>
      </div>
