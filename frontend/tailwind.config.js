  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        "display-md": [
          "2.5rem",
          { lineHeight: "1.1", letterSpacing: "-0.015em", fontWeight: "900" },
        ],
        "display-sm": [
          "1.875rem",
      ...
      backgroundImage: {
        ...
        "gradient-mesh":
          "radial-gradient(at 40% 20%, #10b981 0px, transparent 50%), radial-gradient(at 80% 0%, #059669 0px, transparent 50%), radial-gradient(at 0% 80%, #8b5cf6 0px, transparent 50%)",
      },
      // Emerald Green glow shadows
      boxShadow: {
      ...
      animation: {
        ...
        "athletic-slide-up":
          "athletic-slide-up 0.6s cubic-bezier(0.22, 1, 0.36, 1)",
